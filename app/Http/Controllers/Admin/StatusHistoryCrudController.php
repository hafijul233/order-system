...
class StatusHistoryCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        CRUD::setRoute(config('backpack.base.route_prefix') . '/status-history');
    ...
    protected function setupListOperation()
    {
        ...
        CRUD::column('previous_status_id');
        CRUD::column('updated_at');
        CRUD::column('updated_status_id');
    ...
    protected function setupCreateOperation()
    {
        ...
        CRUD::field('model_id');
        CRUD::field('model_type');
        CRUD::field('previous_status_id');
        CRUD::field('updated_status_id');
